...
# Provides high-level functions for controlling HD44780 LCD displays.
# Includes cursor control, text output, and display configuration.
#
# Hardware-independent layer used by the I2C LCD driver.
# ------------------------------------------------------------------------
# Reference
# ------------------------------------------------------------------------
