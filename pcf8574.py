...
# Provides I2C-based control of an 8-bit GPIO expander.
# Used to interface external devices such as the keypad and LCD.
#
# Includes basic read, write, and pin control operations.
# ------------------------------------------------------------------------
# Reference
# ------------------------------------------------------------------------
...
# https://github.com/mcauser/micropython-pcf8574/blob/master/src/pcf8574.py
# ------------------------------------------------------------------------
# SPDX-FileCopyrightText: 2019 Mike Causer <https://github.com/mcauser>
# SPDX-License-Identifier: MIT
